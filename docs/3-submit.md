...
按照功能点描述基础功能的实现思路（如果实现思路与文档一致，简略描述即可，如果实现思路与文档不同，可以重点描述），以及在实现过程中遇到的难点，如果有新增的成员变量与成员函数，简要概括其作用。如果你认为实验框架中存在一些比较“坑”的地方，如反直觉的设计等，也可以在报告中指出，我们会根据反馈对实验框架做改进。
